...
export default function AuthModal() {
  ...
  const handleGoogleClick = async () => {
    ...
    try {
      ...
      setError(err?.message || "Google लॉगिनमध्ये समस्या आली.");
    } finally {
          ...
          {authModalTab !== 'forgot' && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white border border-gray-300 hover:bg-gray-50 rounded-xl text-gray-700 text-sm font-bold shadow-sm transition-all cursor-pointer hover:border-gray-400 active:scale-[0.99] disabled:opacity-60"
              >
                {isGoogleSubmitting ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin text-brand-red" />
                    <span>Google प्रमाणीकरण सुरू आहे...</span>
                  </>
                ) : (
                  <>
              ...
              {/* Iframe or popup blocked notice */}
              {isInIframe && (
                <div className="mt-2.5 text-center">
                  ...
                  >
                    ...
                    <span>पॉपअप ब्लॉक होत असल्यास: हे अ‍ॅप नवीन टॅबमध्ये उघडा</span>
                  </a>
                </div>
              )}
            </>
